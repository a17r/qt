...
RDEPEND="
	...
	x11-libs/libXrender
	geolocation? ( =dev-qt/qtpositioning-5.7* )
	gstreamer? (
		dev-libs/glib:2
	...
	multimedia? ( =dev-qt/qtmultimedia-5.7*[widgets] )
	opengl? ( =dev-qt/qtopengl-5.7* )
	orientation? ( =dev-qt/qtsensors-5.7* )
	printsupport? ( =dev-qt/qtprintsupport-5.7* )
	qml? ( =dev-qt/qtdeclarative-5.7* )
	webchannel? ( =dev-qt/qtwebchannel-5.7* )
